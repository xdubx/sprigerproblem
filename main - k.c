...
void jumpBack(int pos[2], int dir){
    ...
    //put old var in a array
    restoreArray(pos[0], pos[1]);
/* ------------------------------
        Directions X
        0 = front left
        1 = front right
...
/* ------------------------------
 ...
 ------------------------------  */
    ...
    if(checkRange(posX, posY) == 1){
        ...
        //printf("\t%d%d %d\n", posX, posY, trys);
        // wenn keine 2 m�glichen schritte m�glich sind mache einen zur�ck und �berspringe diesen
            if(trys == 3){
        ...
        posX=posX2;
        posY=posY2;
        //TODO get an backtrack to the last 2 options
        dir++;
        backtrackInt++;
        //printf("%d\t", backtrackInt);
        if(backtrackInt > 16){
